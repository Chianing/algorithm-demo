...
public class Offer_26 {
    ...
    public static void main(String[] args) {
        TreeNode treeNodeA = TreeUtil.initBinaryTree();
        TreeNode treeNodeB = new TreeNode(20);
        treeNodeB.left = new TreeNode(15);

        System.out.printf("result is: %s%n", isSubStructure(treeNodeA, treeNodeB));
    }
